    ...
    fn add_code_page_0_tuple(&mut self) -> &mut Handlers {
        self
            ...
            .add_subset(0x6F, Handlers::new()
                ...
                .set(0x90, load_zeroswapif)
                .set(0x91, load_zeroswapifnot)
                .set(0x92, load_zerorotrif)
                .set(0x93, load_zerorotrifnot)
                .set(0x94, load_zeroswapif2)
                .set(0x95, load_zeroswapifnot2)
                .set(0x96, load_zerorotrif2)
                .set(0x97, load_zerorotrifnot2)
